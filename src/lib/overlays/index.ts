...
import { settingsOverlay, notificationOverlay, messageOverlay, loadingOverlay, confirmationOverlay, promptOverlay, type IOverlayController, type LoadingControllerParams, type TitleMessageParams, type PromptMessageParams, type OverlayControllerResult } from "$lib/overlays/controllers";
export type { LoadingControllerParams, TitleMessageParams, PromptMessageParams, OverlayControllerResult };
...
const promptExport = promptOverlay as IOverlayController<PromptMessageParams, OverlayControllerResult>;
