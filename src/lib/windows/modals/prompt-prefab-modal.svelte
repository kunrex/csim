<script lang="ts">
    import { promptPrefabModal } from "$lib/windows/modals/modal";
    import { PromptPrefabResult } from "$lib/windows/modals/results";
...
{#if promptModal }
    <div class="flex flex-row w-full h-full justify-center items-center z-50">
        <div class="flex flex-col gap-y-4 justify-center min-w-96 w-1/3 items-center fixed right-1/2 top-1/2 translate-x-1/2 -translate-y-1/2 p-4 text-white ui-element">
